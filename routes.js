...
//This array is used to keep track of user recoreds as they are created
const users = [];
...
const authenticateUser = (req, res, next) => {
    ...
    // If a user was successfully retrieved from the data store... Use the bcryptjs npm package to compare the user's password (from the Authorization header) to the user's password that was retrieved from the data store.
        if (user) {
        ...
        message = 'Auth header not founder'
    }
...
router.post('/users', [
    ...
    //If there are validatione errors
    if (!errors.isEmpty()) {
